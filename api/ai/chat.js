...
export default async function handler(req) {
  ...
  // Fallback context jika auth null
  ...
  // --- Proxy ke OpenAI-compatible server jika API KEY dikonfigurasi ---
  ...
  // Fallback AI Trainer response generator dengan konteks lengkap user
